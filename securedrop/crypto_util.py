...
class CryptoUtil:
    ...
    def decrypt(self, secret, ciphertext):
        """
        >>> key = self.genkeypair('randomid', 'randomid')
        >>> self.decrypt('randomid',
        ...   self.encrypt('Goodbye, cruel world!', str(key))
        ... )
        'Goodbye, cruel world!'
        """
